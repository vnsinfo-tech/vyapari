...
export default function PublicInvoice() {
  ...
  if (error || !invoice) return (
    <div style={{ textAlign: 'center', padding: '60px', fontFamily: 'Arial, sans-serif', color: '#6b7280' }}>
      ...
      <div style={{ fontSize: '18px', fontWeight: '600', color: '#374151' }}>Invoice not found</div>
      <div style={{ marginTop: '8px', fontSize: '14px' }}>This invoice link may be invalid or expired.</div>
    </div>
  );
    ...
    <div style={{ minHeight: '100vh', background: '#f3f4f6', padding: '24px 16px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <div style={{ maxWidth: '794px', margin: '0 auto 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <button
          ...
          style={{ display: 'flex', alignItems: 'center', gap: '8px', background: '#16a34a', color: '#fff', border: 'none', borderRadius: '8px', padding: '10px 20px', fontSize: '14px', fontWeight: '600', cursor: downloading ? 'not-allowed' : 'pointer', opacity: downloading ? 0.7 : 1 }}
        >
          <MdDownload size={18} />
